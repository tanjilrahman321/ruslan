!function (n, t) { "object" == typeof exports && "undefined" != typeof module ? module.exports = t() : "function" == typeof define && define.amd ? define(t) : n.Splitting = t() }(this, function () {
    ...
    function b(t) {
        ...
        return g(r, function (n) { var t = Math.round(n[e]); (i[t] || (i[t] = [])).push(n) }), Object.keys(i).map(Number).sort().map(c(i))
    } b.html = function (n) {
        var t = (n = n || {}).target = p()
        return t.innerHTML = n.content, b(n), t.outerHTML
    }, b.add = t
    var x = n("lines", [i], "line", function (n, t, e) { return N(n, { matching: e[i] }, "offsetTop") }), T = n("items", s, "item", function (n, t) { return m(t.matching || n.children, n) }), L = n("rows", s, "row", function (n, t) { return N(n, t, "offsetTop") }), k = n("cols", s, "col", function (n, t) { return N(n, t, "offsetLeft") }), A = n("grid", ["rows", "cols"]), C = "layout", M = n(C, s, s, function (n, t) {
        ...
        var r = t.rows, i = o(r)
        return g(e[C], function (n, t, e) { i[Math.floor(t / (e.length / r))].push(n) }), i
    }), H = n("cellColumns", [C], "col", function (n, t, e) {
        var r = t.columns, i = o(r)
        return g(e[C], function (n, t) { i[t % r].push(n) }), i
    }), O = n("cells", ["cellRows", "cellColumns"], "cell", function (n, t, e) { return e[C] })
